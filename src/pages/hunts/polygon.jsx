    ...
    <div className="relative bg-white w-full h-[665px] overflow-hidden text-left text-[32px] text-black font-work-sans">
      ...
      <div className="absolute top-[56px] left-[21px] w-[348px] h-[605px]">
        ...
        <div className="absolute top-[219px] left-[23px] w-[222px] h-32">
          <b className="absolute top-[0px] left-[0px] tracking-[0.2px] leading-[32px] flex text-center items-center w-[285px] h-[49px] text-[32px]">
            swag @POLYGON
          </b>
        ...
        <div className="absolute top-[363px] left-[23px] w-[302px] h-[133px] text-gray-200">
          <div className="absolute top-[67px] left-[45px] tracking-[0.2px] leading-[14px] flex items-center w-[89px] h-[45px] text-[12px]">
            Exclusive swag at the Polygon booth
          </div>
          <div className="absolute top-[67px] left-[177px] tracking-[0.2px] leading-[14px] flex items-center w-[89px] h-[45px] text-[12px]">
      ...
      <button className="cursor-pointer [border:none] p-0 bg-gray-100 absolute top-[607px] left-[21px] rounded-lg w-[348px] h-[46px]">
        <div className="absolute top-[15px] tracking-[0.6px] leading-[16px] font-medium font-work-sans text-white text-center w-full text-center text-[16px]">
          <Link href={{ pathname: "/WordPuzzle", query: { hunt: "polygon" } }}>Let’s play</Link>
        </div>
      </button>
      <Link href="/">
        <img
          className="absolute top-[14px] left-[21px] w-9 h-9 rotate-90"
          alt=""
          src="../down-icon.svg"
        />
      </Link>
